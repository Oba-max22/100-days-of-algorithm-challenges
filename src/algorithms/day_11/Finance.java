...
rate: annual rate as percent (don't forget to divide by 100*12)
...
public class Finance {
    public static String amort(double rate, int bal, int term, int num_payments) {
        // your code
        String result = String.format("num_payment %d c %.0f princ %.0f int %.0f balance %.0f", rate, bal, term, num_payments);
        return result;
    }
}
