...
/*
 ...
 of beggars, you are supposed to return an array with the sum of what each beggar brings home,
 ...
 [5,7,3], as they will respectively take [1,4], [2,5] and [3].
  ...
  Also note that not all beggars have to take the same amount of "offers", meaning that the length of
  the array is not necessarily a multiple of n; length can be even shorter, in which case the last beggars
...
public class EnglishBeggars {
    public static void main(String[] args) {
        int[] test = {1, 2, 3, 4, 5};
        System.out.println(Arrays.toString(beggars(test, 1))); // {15}
        System.out.println(Arrays.toString(beggars(test, 2))); // {9, 6}
        System.out.println(Arrays.toString(beggars(test, 3))); // {5, 7, 3}
        System.out.println(Arrays.toString(beggars(test, 6))); // {1, 2, 3, 4, 5, 0}
